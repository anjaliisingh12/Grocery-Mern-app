...
const MyOrders = () => {
    ...
    // FIX: Wrap fetchMyOrders in useCallback with axios as a dependency
    ...
    }, [axios]); // Add axios as a dependency

    useEffect(() => {
        fetchMyOrders();
    }, [fetchMyOrders]); // FIX: Add fetchMyOrders to the dependency array
