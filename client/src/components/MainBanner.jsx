...
<div className="relative">  <picture>      
    ...
    <img      
      ...
      height="500"      
    />      
  </picture>      <div className="absolute inset-0 flex flex-col items-start justify-end md:justify-center pb-24 md:pb-0 px-4">      
    <h1 className="text-xl md:text-4xl lg:text-5xl font-bold leading-tight max-w-72 md:max-w-xs">      
      Freshness you can Trust, Savings you will love!      
    </h1>    <div className="flex items-center mt-6 font-medium">      
  <Link      
    to="/products"      
